...

{
  ...
  sops.secrets.learning_turso_db_url = { owner = "kiskaadee"; };
  sops.secrets.learning_turso_auth_token = { owner = "kiskaadee"; };
  sops.secrets.mongo_root_username = { owner = "kiskaadee"; };
  sops.secrets.mongo_root_password = { owner = "kiskaadee"; };
  sops.secrets.ollama_api_key = { owner = "kiskaadee"; };
  sops.secrets.postgres_user = { owner = "kiskaadee"; };
  sops.secrets.postgres_password = { owner = "kiskaadee"; };
  sops.secrets.postgres_db = { owner = "kiskaadee"; };
  ...
  sops.templates."traefik-deployments.env" = {
    ...
    content = ''
      # ==============================================================================
      # Unified Traefik Homelab Apps Environment Config
      # Generated automatically by sops-nix at boot. DO NOT EDIT MANUALLY.
      # ==============================================================================
